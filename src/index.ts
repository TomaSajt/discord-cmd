import { Client, EmojiIdentifierResolvable, Guild, GuildMember, Message, Snowflake, TextChannel } from 'discord.js'
...
export class PrefixCommandHandler {
    ...
    constructor(client: Client, handler: CombinedHandler, { commands, prefix }: PrefixCommandHandlerArgs) {
        this.client = client
...
export class IncludesCommandHandler {
    ...
    constructor(client: Client, handler: CombinedHandler, { commands }: IncludesCommandHandlerArgs) {
        this.client = client
        this.handler = handler
        this.commands = commands
...
export class SlashCommandHandler {
    ...
    constructor(client: Client, handler: CombinedHandler, { globalCommands, guildsCommands }: SlashCommandHandlerArgs) {
        this.client = client
        this.handler = handler
        this.commands = []
    ...
    private handleSlashCommand(interaction: Interaction) {
        ...
        this.commands.forEach(async cmd => {
            ...
            console.log(`${interaction?.data?.name} ${subcommandgroup} ${subcommand}`)
            console.log(args);
